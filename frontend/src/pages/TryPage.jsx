...
import GenAudio from '@/components/GenAudio';
import GenVideo from '@/components/GenVideo';
...
const TryPage = () => {
  ...
  return (
            ...
            <ul className="space-y-2">
              <li>
                <button
                  ...
                  className={ `w-full text-left px-4 py-3 rounded-lg transition-colors duration-200 ${activeTab === 'input'
              ...
              <li>
                <button
                  ...
                  className={ `w-full text-left px-4 py-3 rounded-lg transition-colors duration-200 ${activeTab === 'storage'
                      ? 'bg-purple-500/20 text-purple-400'
                      : 'text-gray-300 hover:bg-purple-500/10 hover:text-purple-400'
                    }` }
                >
    ...
    setFormData={setFormData} />
                ...
                <GenVideo story={ story } setSelectedOption={setSelectedOption}/>
              ) : null }
            </>
          ) }
          { activeTab === 'storage' && (
