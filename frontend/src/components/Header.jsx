        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-10">
            ...
            >
             ...
             <Link to="/novel" 
            className="cursor-pointer bg-gradient-to-r from-green-600 to-teal-600 
            text-white px-4 py-2 rounded-md text-sm font-medium hover:from-green-700 hover:to-teal-700">
              ✨ Write Novel
            </Link>
            <Link to="/try" 
            className="cursor-pointer bg-gradient-to-r from-purple-600 to-pink-600 
            text-white px-4 py-2 rounded-md text-sm font-medium hover:opacity-100 hover:from-purple-700 hover:to-pink-700">
              📚Write Story
            </Link>
          </div>
